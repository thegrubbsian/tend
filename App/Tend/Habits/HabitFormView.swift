...
struct HabitFormView: View {
  ...
  private var navigationActions: some View {
    HStack {
      ...
      .foregroundStyle(model.canSave ? AlmanacPalette.moss : AlmanacPalette.inkMuted)
  ...
  private var reminderDateBinding: Binding<Date> {
    Binding(
      ...
      set: { value in
        guard
          let reminderTime = HabitFormReminderDateAdapter.reminderTime(
            from: value,
            calendar: calendar,
            timeZone: timeZone
          )
...
extension HabitFormValidationError {
