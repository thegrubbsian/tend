...
struct PersistenceContainerTests {
  @Test("production configuration is local and version three")
  func productionConfigurationIsLocalAndVersionThree() {
    ...
    #expect(configuration.schema?.version == Schema.Version(3, 0, 0))
  }
