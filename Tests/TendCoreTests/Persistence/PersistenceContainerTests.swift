...
struct PersistenceContainerTests {
  @Test("production configuration is local and version four")
  func productionConfigurationIsLocalAndVersionFour() {
    ...
    #expect(configuration.schema?.version == Schema.Version(4, 0, 0))
  }
