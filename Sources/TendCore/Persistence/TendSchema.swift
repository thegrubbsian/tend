...
public enum TendSchemaV4: VersionedSchema {
...
public enum TendMigrationPlan: SchemaMigrationPlan {
  public static var schemas: [any VersionedSchema.Type] {
    [TendSchemaV1.self, TendSchemaV2.self, TendSchemaV3.self, TendSchemaV4.self]
  }
  ...
  public static var stages: [MigrationStage] {
    [
      ...
      .lightweight(fromVersion: TendSchemaV3.self, toVersion: TendSchemaV4.self),
    ]
  }
}
